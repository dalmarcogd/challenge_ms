"""server_delta_project URL Configuration
...
from server_delta_app import view_sets
...
api_router.register(r'customers-dossiers', view_sets.CustomerDossierViewSet)

api_public_router = routers.DefaultRouter()
api_public_router.register(r'users', view_sets.PublicUserViewSet)
api_public_router.register(r'customers-dossiers', view_sets.PublicCustomerDossierViewSet)

app_name = 'server_delta_app'
