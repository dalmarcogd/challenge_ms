"""
Django settings for server_alpha_project project.
...
AUTH_USER_MODEL = 'server_alpha_app.UserModel'
...
INSTALLED_APPS = [
    ...
    'server_alpha_app.apps.ServerAlphaConfig'
]
...
ROOT_URLCONF = 'server_alpha_project.urls'
...
WSGI_APPLICATION = 'server_alpha_project.wsgi.application'


# Database
# https://docs.djangoproject.com/en/1.11/ref/settings/#databases
local_db = 'postgres://postgres:postgres@localhost:5432/alpha_db'   
DATABASES = {
